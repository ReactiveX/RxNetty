...
public class HttpClientRequestImplTest {
    ...
    public void testAddChannelHandlerFirstWithGroup() throws Exception {
        String handlerName = "handler1";
        EventExecutorGroup group = new NioClientEventLoopGroup();
        Func0<ChannelHandler> handlerFactory = new Func0<ChannelHandler>() {
            @Override
            public ChannelHandler call() {
                return new ChannelDuplexHandler();
    ...
    public void testSubscribe() throws Exception {
        ...
        Request rawReq = RequestRule.getRawRequest(newReq);
    ...
    public static class RequestRule extends ExternalResource {
        ...
        public Statement apply(final Statement base, Description description) {
            return new Statement() {
                ...
                public void evaluate() throws Throwable {
                    ...
                    request = (HttpClientRequestImpl<Object, ByteBuf>) HttpClientRequestImpl.create(HttpMethod.GET, "/",
        ...
        public void createNewRequest(HttpMethod method, String uri) {
            request = (HttpClientRequestImpl<Object, ByteBuf>) HttpClientRequestImpl.create(method, uri, clientMock);
        }
        ...
        Request assertContentWrite(@SuppressWarnings("rawtypes") Observable contentWritten,
                                           Observable<HttpClientResponse<ByteBuf>> newReq) {
            Request rawRequest = _assertContentWriteContentOnly(contentWritten, newReq);
        ...
        Request assertContentWriteAndFlushOnEach(@SuppressWarnings("rawtypes") Observable contentWritten,
                                                         Observable<HttpClientResponse<ByteBuf>> newReq) {
        ...
        public <T> int assertContentWrite(Observable<T> content, Observable<HttpClientResponse<ByteBuf>> newReq,
            ...
            Request rawReq = getRawRequest(newReq);
        ...
        private Request _assertContentWriteContentOnly(@SuppressWarnings("rawtypes") Observable contentWritten,
                                                       Observable<HttpClientResponse<ByteBuf>> newReq) {
            Request rawRequest = getRawRequest(newReq);
        ...
        static Request getRawRequest(Observable<HttpClientResponse<ByteBuf>> newReq) {
