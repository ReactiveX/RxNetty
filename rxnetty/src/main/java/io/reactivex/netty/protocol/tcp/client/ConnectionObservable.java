 ...
 * {@link #subscribeForEvents(TcpClientEventListener)}
 *
...
public final class ConnectionObservable<R, W> extends Observable<Connection<R, W>> {
    ...
    /**
     * An extension of {@link OnSubscribe} to add {@link #subscribeForEvents(TcpClientEventListener)} for listening to
     * all events on all connectons created from this function.
     *
    ...
    public static abstract class AbstractOnSubscribeFunc<R, W> implements OnSubcribeFunc<R, W> {
         ...
         * function via {@link #subscribeForEvents(TcpClientEventListener)} to the passed {@link ConnectionObservable}
         *
         * @param sub Subcriber
