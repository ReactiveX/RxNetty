...
public class ClientProxyOptionsTests {
	...
	public void asSimpleString() {
		...
		ClientProxyOptions.AddressSpec addrSpec = typeSpec.type(ClientProxyOptions.Proxy.HTTP);
	...
	public void toStringContainsAsDetailedString() {
		ClientProxyOptions.TypeSpec typeSpec = ClientProxyOptions.builder();
		ClientProxyOptions.Builder builder = typeSpec.type(ClientProxyOptions.Proxy.HTTP)
		                                             .host("http://proxy")
		                                             .port(456);
	...
	public void getProxyHandlerTypeSocks4() {
		ClientProxyOptions.TypeSpec typeSpec = ClientProxyOptions.builder();
		ClientProxyOptions.Builder builder = typeSpec.type(ClientProxyOptions.Proxy.SOCKS4)
		                                             .host("http://proxy")
		                                             .port(456);
	...
	public void getProxyHandlerTypeSocks5() {
		ClientProxyOptions.TypeSpec typeSpec = ClientProxyOptions.builder();
		ClientProxyOptions.Builder builder = typeSpec.type(ClientProxyOptions.Proxy.SOCKS5)
		                                           .host("http://proxy")
		                                           .port(456);
