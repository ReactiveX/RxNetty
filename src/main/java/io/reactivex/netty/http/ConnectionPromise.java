...
class ConnectionPromise<T, R extends HttpRequest> extends DefaultPromise<RequestWriter<T, R>> {
    ...
    private HttpNettyPipelineConfigurator<T> handler;

    ConnectionPromise(EventExecutor executor, HttpNettyPipelineConfigurator<T> handler) {
    ...
    void onConnect(Channel channel) {
        ...
        handler.configureNewPipeline(channel.pipeline());
