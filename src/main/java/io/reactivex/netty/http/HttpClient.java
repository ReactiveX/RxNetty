    ...
    public Observable<ObservableHttpResponse<O>> observe(final I request,
        ...
        return connectionObservable.map(new Func1<ObservableConnection<O, I>, ObservableHttpResponse<O>>() {
            ...
            public ObservableHttpResponse<O> call(ObservableConnection<O, I> connection) {
                final ObservableHttpResponse<O> observableResponse = new ObservableHttpResponse<O>(connection);
                connection.writeNow(request).doOnError(new Action1<Throwable>() {
                    @Override
                    public void call(Throwable throwable) {
                        ...
                        observableResponse.headerSubject().onError(throwable);
                        observableResponse.contentSubject().onError(throwable);
                    }
                });
