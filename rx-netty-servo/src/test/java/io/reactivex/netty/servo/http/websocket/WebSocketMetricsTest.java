...
public class WebSocketMetricsTest {
    ...
    public void setUp() throws Exception {
        factory = new ServoEventsListenerFactory("websocket-metric-test-client", "websocket-metric-test-server");
    }
    ...
    public void testWebSocketClientMetrics() throws Exception {
        ...
        assertEquals("Expected handshake processing time of 10ms", Long.valueOf(10), listener.getHandshakeProcessingTimes().getValue());
