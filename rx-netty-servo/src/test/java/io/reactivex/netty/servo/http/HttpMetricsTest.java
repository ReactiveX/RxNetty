...
public class HttpMetricsTest {
    ...
    public void setUp() throws Exception {
        factory = new ServoEventsListenerFactory("http-metric-test-client", "http-metric-test-server");
    }
    ...
    public void testServerMetrics() throws Exception {
        ...
        Assert.assertEquals("Unexpected response write times.", 1, (long) listener.getResponseWriteTimes().getValue());
    ...
    private static void doRequestStart(MetricEventsSubject<ServerMetricsEvent<?>> eventsSubject,
        ...
        Assert.assertEquals("Unexpected inflight requests.", 1, (long) listener.getRequestReadTimes().getValue());
    }
}
