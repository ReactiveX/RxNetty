...
import io.reactivex.netty.server.context.DirectionAwareSerializerAdapter;
...
public class TestContextDirectionalSerializer extends DirectionAwareSerializerAdapter<BidirectionalTestContext> {
    ...
    public int serializationInboundCallReceived;
    public int deserializationInboundCallReceived;
    public int serializationOutboundCallReceived;
    public int deserializationOutboundCallReceived;
